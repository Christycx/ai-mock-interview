...
def store_face_feedback(feedback, session_id=None, qno=None):
    """
    ...
    Note: student_id is AUTO_INCREMENT and will be generated by the database
    """
    ...
    try:
        ...
        print(f"📝 Inserting face feedback: qno={qno}, session_id={session_id}")
